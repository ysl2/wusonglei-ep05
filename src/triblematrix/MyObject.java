...
public class MyObject implements Comparable<MyObject> {
    ...
    public MyObject(int w1, int w2, int w3, int w4, int w5, int w6) {
        this.w1 = w1;
        this.w2 = w2;
        this.w3 = w3;
        this.w4 = w4;
    ...
    public int hashCode() {
        ...
        result = prime * result + w5;
        result = prime * result + w6;
        return result;
    }
    ...
    public String toString() {
        return "MyObject [w1=" + w1 + ", w2=" + w2 + ", w3=" + w3 + ", w4=" + w4 + ", w5=" + w5 + ", w6=" + w6 + "]";
    }
    ...
    public int compareTo(MyObject o) {
        ...
        int result5 = (result4 == 0) ? (this.w5 - o.w5) : result4;
        int result6 = (result5 == 0) ? (this.w6 - o.w6) : result5;
        return result6;
    }
}
